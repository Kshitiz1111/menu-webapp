...
import { setTagActive } from "../slice/Filter";
...
const Starter = ()=>{
    ...
    const tags = useSelector((state)=>state.Filter.activeTags);
    //this is activetags
    console.log(tags);
        ...
        <InnerNav orderListToggleHandler={orderListToggleHandler}></InnerNav>
            ...
            <div className="flex justify-between px-4 my-1">
                <div className="flex overflow-x-scroll overflow-y-hidden py-2">
                    <span onClick={(e)=>sendId(e)} id="1" active='0' className="text-sm px-2 min-w-fit min-h-fit py-1 m-1 bg-gray-100 rounded-full shadow-md hover:shadow-inner hover:cursor-pointer ">all</span>
                    ...
                    <span onClick={(e)=>sendId(e)} id="4" active='0' className="text-sm px-2 min-w-fit min-h-fit py-1 m-1 bg-gray-100 rounded-full shadow-md hover:shadow-inner hover:cursor-pointer">customer choice</span>
                    <span onClick={(e)=>sendId(e)} id="5" active='0' className="text-sm px-2 min-w-fit min-h-fit py-1 m-1 bg-gray-100 rounded-full shadow-md hover:shadow-inner hover:cursor-pointer">your choice</span>
